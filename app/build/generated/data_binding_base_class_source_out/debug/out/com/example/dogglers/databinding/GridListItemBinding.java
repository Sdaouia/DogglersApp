...
public final class GridListItemBinding implements ViewBinding {
  ...
  public static GridListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.item_dogAge;
      TextView itemDogAge = ViewBindings.findChildViewById(rootView, id);
      if (itemDogAge == null) {
        break missingId;
      }

      id = R.id.item_dogHobbies;
      TextView itemDogHobbies = ViewBindings.findChildViewById(rootView, id);
      if (itemDogHobbies == null) {
        break missingId;
      }

      id = R.id.item_dogName;
      TextView itemDogName = ViewBindings.findChildViewById(rootView, id);
      if (itemDogName == null) {
        break missingId;
      }
